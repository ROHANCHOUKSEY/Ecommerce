...
const AdminLogin = () => {
    ...
    const{setIsLoggined} = useContext(AdminContext);
    ...
    const handleSubmitLogin = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await fetch("http://localhost:3002/admin/adminlogin", {
                method: "POST",
                credentials: "include",
            ...
            if (error.message) {
                ...
                setLoginError("Error during admin login");
            }
        } finally {
            setLoading(false);
        }
                ...
                <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-8">
                    ...
                    <div className="mt-6 text-center text-gray-600">
                        <p>
                            ...
                            <NavLink to="/adminregistration" className="text-blue-500 hover:underline">
                                Register Now
                            </NavLink>
                        </p>
                    </div>
